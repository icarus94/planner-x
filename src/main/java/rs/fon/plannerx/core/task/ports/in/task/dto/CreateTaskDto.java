...
public class CreateTaskDto extends SelfValidating<CreateTaskDto> {
    ...
    public CreateTaskDto(int userId, int taskListId, String description, LocalDateTime dueDate, TaskPriority taskPriority) {
        this.userId = userId;
